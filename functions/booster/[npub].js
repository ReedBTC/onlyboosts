...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/nav.css?v=ob-v90" />
  <link rel="stylesheet" href="/assets/css/footer.css?v=ob-v90" />
  <link rel="stylesheet" href="/assets/css/theme.css?v=ob-v90" />
  <link rel="stylesheet" href="/assets/css/page.css?v=ob-v90" />
  <!-- The hero, the drawers and the boost list are the show page's, so this
       page links its stylesheet and adds only the deltas. -->
  <link rel="stylesheet" href="/assets/css/show-page.css?v=ob-v90" />
  <!-- The episode card, for the #episodes rollup: the same chrome
       feeds-podcasts.js paints on the homepage. -->
  <link rel="stylesheet" href="/assets/css/feed-cards.css?v=ob-v90" />
  <!-- The boost thread inside a card's drawer, and its reply / like / repost /
       zap bar, both reached through that same card. -->
  <link rel="stylesheet" href="/assets/css/boosts-thread.css?v=ob-v90" />
  <link rel="stylesheet" href="/assets/css/boost-actions.css?v=ob-v90" />
  <link rel="stylesheet" href="/assets/css/episode-page.css?v=ob-v90" />
  <link rel="stylesheet" href="/assets/css/booster-page.css?v=ob-v90" />
</head>
...
<script src="/assets/js/nav.js?v=ob-v90" defer></script>
<script src="/assets/js/booster-page.js?v=ob-v90" type="module"></script>
<!-- Lazy widget bootstrap. Plain (non-defer) script at the end of body, as on
     every page — see CLAUDE.md. -->
<script src="/assets/js/nav-widget-boot.js?v=ob-v90"></script>
<script src="/assets/js/sw-register.js?v=ob-v90" defer></script>
</body>
</html>`;
}
