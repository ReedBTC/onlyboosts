...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/supporter-wall.css?v=ob-v164" />
  <!-- The episode card, for the #episodes rollup: the same chrome
       feeds-podcasts.js paints on the homepage. -->
  <link rel="stylesheet" href="/assets/css/feed-cards.css?v=ob-v164" />
  <!-- The boost thread inside a card's drawer, and its reply / like / repost /
       zap bar, both reached through that same card. -->
  <link rel="stylesheet" href="/assets/css/boosts-thread.css?v=ob-v164" />
  <link rel="stylesheet" href="/assets/css/boost-actions.css?v=ob-v164" />
  <link rel="stylesheet" href="/assets/css/episode-page.css?v=ob-v164" />
  <link rel="stylesheet" href="/assets/css/booster-page.css?v=ob-v164" />
</head>
...
<script src="/assets/js/booster-page.js?v=ob-v164" type="module"></script>
