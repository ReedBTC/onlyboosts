...
<div class="hpw-page" data-hpw-page="${htmlEscape(d.key)}"${d.isCurrent ? ' data-hpw-live="1"' : ""} data-hpw-image="${htmlEscape(image)}" data-hpw-url="${htmlEscape(pageUrl)}">
  ...
  return shell({
    ...
    scripts: `<script src="/assets/js/hpw-page.js?v=ob-v201" type="module"></script>`,
    extraCss: `
...
export function renderCard(view) {
  ...
  return cardHtml({
    ...
    links: `  <link rel="stylesheet" href="/assets/css/hpw-board.css?v=ob-v201" />
...
` : ""}
  ...
  <link rel="stylesheet" href="/assets/css/hpw-board.css?v=ob-v201" />
  <link rel="stylesheet" href="/assets/css/theme.css?v=ob-v201" />
