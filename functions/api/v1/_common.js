 ...
 *
 * ⚠️ THE FIFTH IS Boostr_Bot (adab4ccd…0649), REGISTERED 2026-09-10 ON REED'S
 * INSTRUCTION. A split-recipient republisher: a podcaster adds
 * boostr@getalby.com as a 1% leg of their value block and the bot publishes a
 * note for every boost that leg receives, whichever app sent it (the origin
 * app rides an `["app", <name>, <version>]` tag). Every note is signed by the
