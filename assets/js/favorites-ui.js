 ...
 */
import { fetchFavorites, syncFavorites, widgetDeps, saveMode } from '/assets/js/favorites-sync.js?v=ob-v200'
import { setFavoriteState, changeFor, keyFor } from '/assets/js/favorite-button.js?v=ob-v200'
...
const WIDGET_SRC = '/assets/widgets/login-widget.js?v=ob-v200'
