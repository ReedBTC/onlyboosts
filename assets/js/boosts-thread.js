 ...
 * mutating repaints.
 */
import { SimplePool, nip19, verifyEvent } from '/assets/widgets/nostr-tools.js?v=ob-v77'
// Primal profile lookup lives in its own module so /show pages can use it
// without importing this one. See primal-profiles.js.
import { primalQuery, fetchProfilesFromPrimal, parseProfileEvent } from '/assets/js/primal-profiles.js?v=ob-v77'
import {
  KIND_DATE_EVENT,
  KIND_TIME_EVENT,
