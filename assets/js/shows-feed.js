...
} from '/assets/js/ob-live.js?v=ob-v96'
import {
...
import { mountFeedNote, resetFeedNote } from '/assets/js/feed-note.js?v=ob-v96'
import {
  LANG_ALL, languageOptions, langControl, langNote, langNoMatchText, langLabelFor,
} from '/assets/js/feed-lang.js?v=ob-v96'
import { mountFeedSearch, resetFeedSearch } from '/assets/js/feed-search.js?v=ob-v96'
import { competitionRanks, rankLabel } from '/assets/js/rank.js?v=ob-v96'
...
import { boostButton, withBoostBusy } from '/assets/js/boost-button.js?v=ob-v96'
