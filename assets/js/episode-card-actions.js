...
import { copyText, showToast, copyNpub } from '/assets/js/copy-npub.js?v=ob-v61'
import { withBoostBusy } from '/assets/js/boost-button.js?v=ob-v61'
import { wireArt2, blankTile, hydrateProfiles } from '/assets/js/detail-page.js?v=ob-v61'
...
async function copyNevent(eventId, author) {
  let nevent = ''
  try {
    const { nip19 } = await import('/assets/widgets/nostr-tools.js?v=ob-v61')
