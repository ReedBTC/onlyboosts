...
import { copyText, showToast, copyNpub } from '/assets/js/copy-npub.js?v=ob-v64'
import { withBoostBusy } from '/assets/js/boost-button.js?v=ob-v64'
import { wireArt2, blankTile, hydrateProfiles } from '/assets/js/detail-page.js?v=ob-v64'
...
async function copyNevent(eventId, author) {
  let nevent = ''
  try {
    const { nip19 } = await import('/assets/widgets/nostr-tools.js?v=ob-v64')
...
async function attachActionBars(details) {
  let actions
  try {
    actions = await import('/assets/js/boost-actions.js?v=ob-v64')
