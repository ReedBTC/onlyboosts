...
import { copyText, showToast, copyNpub } from '/assets/js/copy-npub.js?v=ob-v202'
import { withBoostBusy } from '/assets/js/boost-button.js?v=ob-v202'
import { wireArt2, blankTile, hydrateProfiles } from '/assets/js/detail-page.js?v=ob-v202'
...
import { boostRowsHtml, namesFrom } from '/assets/js/episode-card.js?v=ob-v202'
import { normalizeBoosts, toEpisodeShape } from '/assets/js/ob-data.js?v=ob-v202'
...
async function copyNevent(eventId, author) {
  let nevent = ''
  try {
    const { nip19 } = await import('/assets/widgets/nostr-tools.js?v=ob-v202')
...
async function attachActionBars(details) {
  let actions
  try {
    actions = await import('/assets/js/boost-actions.js?v=ob-v202')
