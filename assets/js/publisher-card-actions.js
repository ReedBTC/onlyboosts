 ...
 */
import { wireArt2 } from '/assets/js/detail-page.js?v=ob-v202'
import { getPublisherAlbums, getPublisherAlbumsFollows } from '/assets/js/ob-live.js?v=ob-v202'
import { COPY, albumRowsHtml } from '/assets/js/publisher-card.js?v=ob-v202'
import { num } from '/assets/js/show-card.js?v=ob-v202'
