 ...
 */
import { wireArt2 } from '/assets/js/detail-page.js?v=ob-v187'
import { getPublisherAlbums, getPublisherAlbumsFollows } from '/assets/js/ob-live.js?v=ob-v187'
import { COPY, albumRowsHtml } from '/assets/js/publisher-card.js?v=ob-v187'
import { num } from '/assets/js/show-card.js?v=ob-v187'
