...
import { getSessionPubkey, clearFollowCache } from '/assets/js/follow-set.js?v=ob-v199'
import '/assets/js/favorites-ui.js?v=ob-v199'
...
const BOOSTS = '/assets/js/boosts-feed.js?v=ob-v199'
const PODCASTS = '/assets/js/feeds-podcasts.js?v=ob-v199'
const SHOWS = '/assets/js/shows-feed.js?v=ob-v199'
const ARTISTS = '/assets/js/artists-feed.js?v=ob-v199'
...
function loadMemberBoards() {
  ...
  if (!root) return
  boardsWired = true
  import('/assets/js/members-board.js?v=ob-v199')
...
function loadChartsBlock(feed) {
  ...
  import('/assets/js/charts-block.js?v=ob-v199')
