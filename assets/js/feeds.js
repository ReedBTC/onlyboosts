...
import { getSessionPubkey, clearFollowCache } from '/assets/js/follow-set.js?v=ob-v155'
...
const BOOSTS = '/assets/js/boosts-feed.js?v=ob-v155'
const PODCASTS = '/assets/js/feeds-podcasts.js?v=ob-v155'
const SHOWS = '/assets/js/shows-feed.js?v=ob-v155'
...
function loadMemberBoards() {
  ...
  if (!root) return
  boardsWired = true
  import('/assets/js/members-board.js?v=ob-v155')
