...
import { getSessionPubkey, clearFollowCache } from '/assets/js/follow-set.js?v=ob-v191'
...
const BOOSTS = '/assets/js/boosts-feed.js?v=ob-v191'
const PODCASTS = '/assets/js/feeds-podcasts.js?v=ob-v191'
const SHOWS = '/assets/js/shows-feed.js?v=ob-v191'
const ARTISTS = '/assets/js/artists-feed.js?v=ob-v191'
...
function loadMemberBoards() {
  ...
  if (!root) return
  boardsWired = true
  import('/assets/js/members-board.js?v=ob-v191')
...
function loadChartsBlock(feed) {
  ...
  import('/assets/js/charts-block.js?v=ob-v191')
