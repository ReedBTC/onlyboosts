...
import { wireArt2 } from '/assets/js/detail-page.js?v=ob-v175'
import { episodeBoostLink } from '/assets/js/episode-link.js?v=ob-v175'
import { getShowEpisodes, getShowEpisodesFollows } from '/assets/js/ob-live.js?v=ob-v175'
