...
import { wireArt2 } from '/assets/js/detail-page.js?v=ob-v169'
import { episodeBoostLink } from '/assets/js/episode-link.js?v=ob-v169'
import { getShowEpisodes, getShowEpisodesFollows } from '/assets/js/ob-live.js?v=ob-v169'
...
} from '/assets/js/show-card.js?v=ob-v169'
