...
import { wireArt2 } from '/assets/js/detail-page.js?v=ob-v210'
import { episodeBoostLink } from '/assets/js/episode-link.js?v=ob-v210'
import { getShowEpisodes, getShowEpisodesFollows } from '/assets/js/ob-live.js?v=ob-v210'
    ...
    try {
      ...
      window.LBLogin.openExternalBoost({
        episode: {
          ...
          feedUrl: feed || '',   // the boostagram's `url` (bLIP-10)
        },
