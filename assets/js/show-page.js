...
import { fromApiValue, applyExternalOverrides } from '/assets/js/value-block.js?v=ob-v211'
import { episodeBoostLink } from '/assets/js/episode-link.js?v=ob-v211'
...
import { sortControl } from '/assets/js/feed-controls.js?v=ob-v211'
// The drawers' chart standing, the same function the Function ordered them by.
import { chartRanks, rankLabel } from '/assets/js/rank.js?v=ob-v211'
...
import { initShowDesc } from '/assets/js/show-desc.js?v=ob-v211'
...
import { initBoostNoteActions } from '/assets/js/boost-note-actions.js?v=ob-v211'
import { initBoostSection } from '/assets/js/boost-section.js?v=ob-v211'
...
import { initEpisodeCatalogue } from '/assets/js/episode-catalogue.js?v=ob-v211'
...
async function openBoost(bundle, { itemGuid = '', episodeTitle = '', target = SHOW } = {}) {
  ...
  window.LBLogin.openExternalBoost({
    episode: {
      ...
      feedUrl: target?.feed || '',   // the boostagram's `url` (bLIP-10)
    },
