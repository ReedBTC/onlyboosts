 ...
 *
 *   SyntaxError: The requested module '/assets/js/feed-controls.js?v=ob-v192' does not
 ...
 *
 * (A `charts` option appended the CHARTS wordmark link to /charts from
 * 2026-09-01 to 2026-09-03; Reed cut it with the wordmark itself — the
 * charts live on the feeds now, and the page is coming down.)
 */
