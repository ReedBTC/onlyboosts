...
(function () {
  ...
  function ensureWidget() {
    ...
    window.__lbWidgetLoad = new Promise(function (resolve, reject) {
      ...
      s.src = '/assets/widgets/login-widget.js?v=ob-v206'
      s.async = true
  ...
  // The Favorite hearts and the account menu's favorites row share one
  ...
  try { import('/assets/js/favorites-ui.js?v=ob-v206').catch(function () {}) } catch (e) {}
})()
