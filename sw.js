...
// ob-v180: the 40 HPW tab's all-time board becomes "Proof of #40HPW" — one row
// per member who has ever cleared forty hours in a week, ranked by how many,
// where it was the ten biggest booster-weeks. REQUIRED: hpw-board.js's row and
...
const PRECACHE_URLS = [
  ...
  '/assets/css/theme.css?v=ob-v185',
  '/assets/css/page.css?v=ob-v185',
  '/assets/css/nav.css?v=ob-v185',
  '/assets/css/footer.css?v=ob-v185',
  '/assets/css/boosts-thread.css?v=ob-v185',
  '/assets/css/boost-actions.css?v=ob-v185',
  ...
  '/assets/css/feed-cards.css?v=ob-v185',
  '/assets/js/boosts-thread.js?v=ob-v185',
  ...
  '/assets/js/primal-profiles.js?v=ob-v185',
  '/assets/js/boost-actions.js?v=ob-v185',
  '/assets/js/nav.js?v=ob-v185',
  '/assets/js/nav-widget-boot.js?v=ob-v185',
  '/assets/js/widget-loader.js?v=ob-v185',
  '/assets/js/sw-register.js?v=ob-v185',
];
