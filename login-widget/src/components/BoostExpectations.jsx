...
export default function BoostExpectations({
  ...
  return (
    <div className="text-[11px] text-[var(--muted,#5a7488)] leading-snug rounded-md border border-[var(--modal-line,#b9d4e6)] bg-[var(--modal-inset,#e6f1f9)] px-3 py-2.5 space-y-1.5">
